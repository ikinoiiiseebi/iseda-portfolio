...
export const events: ProjectEvent[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: '琴葉ggr姉妹様のYouTubeチャンネル', url: 'https://www.youtube.com/@KOTONOHAggrSISTERS' },
    ],
  },
  {
